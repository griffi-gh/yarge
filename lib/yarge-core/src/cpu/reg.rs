...
impl Registers {
  ...
  // Union registers set
  pub fn set_af(&mut self, v: u16) { self.af.set(v); }
  pub fn set_bc(&mut self, v: u16) { self.bc.set(v); }
  pub fn set_de(&mut self, v: u16) { self.de.set(v); }
  pub fn set_hl(&mut self, v: u16) { self.hl.set(v); }
  ...
  // 8-bit registers set
  pub fn set_a(&mut self, val: u8) { self.af.set_a(val) }
  pub fn set_f(&mut self, val: u8) { self.af.set_b(val) }
  pub fn set_b(&mut self, val: u8) { self.bc.set_a(val) }
  pub fn set_c(&mut self, val: u8) { self.bc.set_b(val) }
  pub fn set_d(&mut self, val: u8) { self.de.set_a(val) }
  pub fn set_e(&mut self, val: u8) { self.de.set_b(val) }
  pub fn set_h(&mut self, val: u8) { self.hl.set_a(val) }
  pub fn set_l(&mut self, val: u8) { self.hl.set_b(val) }
